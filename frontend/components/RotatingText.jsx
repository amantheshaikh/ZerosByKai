            ...
            <AnimatePresence mode={animatePresenceMode} initial={!hasBeenVisible}>
                ...
                >
                    {elements.map((wordObj, wordIndex, array) => {
                        ...
                        return (
                            <span key={wordIndex} className={cn(styles['text-rotate-word'], splitLevelClassName)}>
                                {wordObj.characters.map((char, charIndex) => (
                                    <motion.span
                                        ...
                                        className={cn(styles['text-rotate-element'], elementLevelClassName)}
                                    >
                                        {char}
                                    </motion.span>
                                ))}
                                {wordObj.needsSpace && <span className={styles['text-rotate-space']}> </span>}
                            </span>
                        );
                    })}
                </motion.span>
